...
<template>
    ...
    <Transition name="fade">
        <div class="modal" v-if="modals.isModalShown('caseOpen')">
            <div class="modal-content">
                <div class="modal-content_top">
                    <div class="modal-content_title">Открыть кейс</div>
                    <close-button class="modal-content_close" v-on:click="modals.hideModal('caseOpen'); roulette.animationState = null"/>
                </div>
