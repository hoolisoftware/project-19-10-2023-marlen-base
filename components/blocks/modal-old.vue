...
<template>
    ...
    <div class="modal" v-if="modalStores.isModalShown('signIn')">
      <div class="modal-content">
        <div class="modal-content_top">
          ...
          <div class="modal-content_close" v-on:click="modalStores.hideModal('signIn')">
    ...
    <div class="modal" v-if="modalStores.isModalShown('deposit')">
      <div class="modal-content">
        <div class="modal-content_top">
          ...
          <div class="modal-content_close" v-on:click="modalStores.hideModal('deposit')">
            <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
                d="M2.34315 2.34315C0 4.68629 0 8.45753 0 16V18C0 25.5425 0 29.3137 2.34315 31.6569C4.68629 34 8.45753 34 16 34H18C25.5425 34 29.3137 34 31.6569 31.6569C34 29.3137 34 25.5425 34 18V16C34 8.45753 34 4.68629 31.6569 2.34315C29.3137 0 25.5425 0 18 0H16C8.45753 0 4.68629 0 2.34315 2.34315ZM22.3525 10L23.9995 11.647L18.6468 16.9997L23.9997 22.3526L22.3527 23.9996L16.9998 18.6467L11.647 23.9995L10 22.3525L15.3528 16.9997L10.0001 11.647L11.6471 10L16.9998 15.3527L22.3525 10Z"
                :fill="themeStores.isDarkTheme ? 'white' : 'black'" />
        ...
        <div class="modal-content_body">
          <div class="deposit">
            <div class="deposit-value">
              ...
              <div class="deposit-input">
                ...
                <input type="number" v-model="morFromRub" placeholder="Сумма" disabled />
              </div>
            </div>
            ...
            <div class="deposit-method">
              ...
              <div class="deposit-method_list">
                <div class="deposit-method_item" v-on:click="activeMethod = 1">
                  <svg v-if="activeMethod === 1" xmlns="http://www.w3.org/2000/svg" width="512" height="512"
                    viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve">
                    <path
                      d="M256 42.667C138.453 42.667 42.667 138.453 42.667 256S138.453 469.333 256 469.333 469.333 373.547 469.333 256 373.547 42.667 256 42.667zm100.48 185.812L249.814 335.146a21.635 21.635 0 0 1-30.294 0l-64-64a21.42 21.42 0 1 1 30.294-30.292l48.853 49.063 91.519-91.729a21.42 21.42 0 0 1 30.294 30.291z"
                      data-name="check-circle-Filled" fill="#32bb76" data-original="#000000" />
                  </svg>
                  <nuxt-img format="webp" src="/img/deposit/method_1.png" />
                </div>
                <div class="deposit-method_item" v-on:click="activeMethod = 2">
                  <svg v-if="activeMethod === 2" xmlns="http://www.w3.org/2000/svg" width="512" height="512"
                    viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve">
                    <path
                      d="M256 42.667C138.453 42.667 42.667 138.453 42.667 256S138.453 469.333 256 469.333 469.333 373.547 469.333 256 373.547 42.667 256 42.667zm100.48 185.812L249.814 335.146a21.635 21.635 0 0 1-30.294 0l-64-64a21.42 21.42 0 1 1 30.294-30.292l48.853 49.063 91.519-91.729a21.42 21.42 0 0 1 30.294 30.291z"
                      data-name="check-circle-Filled" fill="#32bb76" data-original="#000000" />
          ...
          <medium-button color="green" text="К оплате" @click="() => { tmpTransaction(morFromRub); this.rubValue = null }" />
        </div>
      </div>
    </div>
  </Transition>
  ...
  <Transition name="fade">
    <div class="modal" v-if="modalStores.isModalShown('caseOpen')">
      <div class="modal-content">
        <div class="modal-content_top">
          <div class="modal-content_title">Открыть кейс</div>
          <div class="modal-content_close"
            v-on:click="modalStores.hideModal('caseOpen'); rouletteStores.animationState = null">
            <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
                d="M2.34315 2.34315C0 4.68629 0 8.45753 0 16V18C0 25.5425 0 29.3137 2.34315 31.6569C4.68629 34 8.45753 34 16 34H18C25.5425 34 29.3137 34 31.6569 31.6569C34 29.3137 34 25.5425 34 18V16C34 8.45753 34 4.68629 31.6569 2.34315C29.3137 0 25.5425 0 18 0H16C8.45753 0 4.68629 0 2.34315 2.34315ZM22.3525 10L23.9995 11.647L18.6468 16.9997L23.9997 22.3526L22.3527 23.9996L16.9998 18.6467L11.647 23.9995L10 22.3525L15.3528 16.9997L10.0001 11.647L11.6471 10L16.9998 15.3527L22.3525 10Z"
                :fill="themeStores.isDarkTheme ? 'white' : 'black'" />
