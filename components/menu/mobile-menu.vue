...
<template>
  <div class="menu">
    <nuxt-link exact @click="closeMenu" to="/" class="menu-item" exact-active-class="menu-item_active">
      <span>Кейсы</span>
      <div class="menu-item_border"></div>
    </nuxt-link>
    <nuxt-link to="/shop" @click="closeMenu" class="menu-item" active-class="menu-item_active">
      <span>Магазин</span>
      <div class="menu-item_border"></div>
    </nuxt-link>
    <nuxt-link to="/alchemy" @click="closeMenu" class="menu-item" active-class="menu-item_active">
      <span>Алхимия</span>
      <div class="menu-item_border"></div>
    </nuxt-link>
    <nuxt-link to="/lottery" @click="closeMenu" class="menu-item" active-class="menu-item_active">
      <span>Лотерея</span>
      <div class="menu-item_border"></div>
    </nuxt-link>
    <nuxt-link to="/auction" @click="closeMenu" class="menu-item" active-class="menu-item_active">
      <span>Аукцион</span>
      <div class="menu-item_border"></div>
    </nuxt-link>
    <nuxt-link to="/reviews" @click="closeMenu" class="menu-item" active-class="menu-item_active">
      <span>Отзывы</span>
      <div class="menu-item_border"></div>
    </nuxt-link>
    <br><br>
...
<script>
import mediumButton from "../buttons/medium-button.vue";
export default {
  name: "header-menu",
  methods: {
    closeMenu() {
      // Изменяем состояние родителя через событие
      this.$emit('closeMenu');
    },
  }
}
