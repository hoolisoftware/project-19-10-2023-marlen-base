...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.6bfab7dc.mjs').then(interopDefault),
  "pages/alchemy.vue": () => import('./_nuxt/alchemy-styles.7761c172.mjs').then(interopDefault),
  ...
  "pages/reviews.vue": () => import('./_nuxt/reviews-styles.21affc1b.mjs').then(interopDefault),
