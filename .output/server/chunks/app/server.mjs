...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/alchemy-a4d9166b.mjs').then((m) => m.default || m)
  },
  {
    name: "auction",
    path: "/auction",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/auction-9ead9c0f.mjs').then((m) => m.default || m)
  },
  {
    name: "case-id",
    path: "/case/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-b26f13ba.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a09e2ef1.mjs').then((m) => m.default || m)
  },
  {
    name: "lottery",
    path: "/lottery",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/lottery-d2817d20.mjs').then((m) => m.default || m)
  },
  {
    name: "profile",
    path: "/profile",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/profile-6d0a29c5.mjs').then((m) => m.default || m)
  },
  {
    name: "purchase-id",
    path: "/purchase/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-27f9b309.mjs').then((m) => m.default || m)
  },
  {
    name: "results",
    path: "/results",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/results-75222192.mjs').then((m) => m.default || m)
  },
  {
    name: "reviews",
    path: "/reviews",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/reviews-cb9e6392.mjs').then((m) => m.default || m)
  },
  {
    name: "shop",
    path: "/shop",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/shop-80bc2896.mjs').then((m) => m.default || m)
  },
  {
    name: "user-id",
    path: "/user/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-03c2a563.mjs').then((m) => m.default || m)
  }
];
...
const LazyNuxtIcon = defineAsyncComponent(() => import('./_nuxt/nuxt-icon-c75976ab.mjs').then((r) => r.default));
...
const layouts = {
  default: () => import('./_nuxt/default-2ba1cb9b.mjs').then((m) => m.default || m),
  list: () => import('./_nuxt/list-8c5f557c.mjs').then((m) => m.default || m)
};
...
const ipxRuntime$1D7pKX39hA = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$1D7pKX39hA, defaults: void 0 }
};
const useImage = () => {
...
const useThemeStore = defineStore("store", {
  state: () => {
    return {
      darkTheme: false
    };
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "button " + (__props.color ? __props.color : "") + (__props.border ? " button-bordered" : ""),
        "data-theme": unref(theme).darkTheme ? "dark" : "light"
      }, _attrs))} data-v-04d81318>${ssrInterpolate(__props.text)}</div>`);
    };
  }
});
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/buttons/medium-button.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const MediumButton = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-04d81318"]]);
const _sfc_main$1 = {
  components: { MediumButton },
  head: {
    title: "Kleewish | Ошибка"
  },
  props: ["error"]
};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="error"${_scopeId}>`);
        ...
        if ($props.error.statusCode) {
          _push2(`<h1${_scopeId}>Ошибка ${ssrInterpolate($props.error.statusCode)}</h1>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<p${_scopeId}>Вы попали на несуществующую страницу</p><p${_scopeId}>Кли грустит</p>`);
        _push2(ssrRenderComponent(_component_nuxt_link, { to: "/" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div${_scopeId2}>`);
              _push3(ssrRenderComponent(_component_medium_button, { text: "Вернуться на главную" }, null, _parent3, _scopeId2));
              _push3(`</div>`);
            } else {
              return [
                createVNode("div", null, [
                  createVNode(_component_medium_button, { text: "Вернуться на главную" })
                ])
              ];
            }
          }),
        ...
        return [
          createVNode("div", { class: "error" }, [
            ...
            $props.error.statusCode ? (openBlock(), createBlock("h1", { key: 0 }, "Ошибка " + toDisplayString($props.error.statusCode), 1)) : createCommentVNode("", true),
            createVNode("p", null, "Вы попали на несуществующую страницу"),
            createVNode("p", null, "Кли грустит"),
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-01e106a4.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { MediumButton as M, _export_sfc as _, __nuxt_component_0 as a, useThemeStore as b, createError as c, defineStore as d, entry$1 as default, __nuxt_component_0$3 as e, __nuxt_component_0$2 as f, useRoute as u };
