...
import { a as authStore, G as Game, b as api, _ as _imports_0 } from './profile-0a5833a7.mjs';
...
function _sfc_ssrRender$a(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$3;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "menu" }, _attrs))} data-v-1664b52e>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span data-v-1664b52e${_scopeId}>\u041A\u0435\u0439\u0441\u044B</span><div class="menu-item_border" data-v-1664b52e${_scopeId}></div>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span data-v-1664b52e${_scopeId}>\u041C\u0430\u0433\u0430\u0437\u0438\u043D</span><div class="menu-item_border" data-v-1664b52e${_scopeId}></div>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span data-v-1664b52e${_scopeId}>\u0422\u0430\u0439\u043D\u0438\u043A</span><div class="menu-item_border" data-v-1664b52e${_scopeId}></div>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span data-v-1664b52e${_scopeId}>\u0410\u043B\u0445\u0438\u043C\u0438\u044F</span><div class="menu-item_border" data-v-1664b52e${_scopeId}></div>`);
      } else {
        return [
  ...
  _push(`<div class="menu-item" data-v-1664b52e><span data-v-1664b52e>\u0414\u0440\u0443\u0433\u0438\u0435 \u0440\u0435\u0436\u0438\u043C\u044B <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 451.847 451.847" style="${ssrRenderStyle({ "enable-background": "new 0 0 512 512" })}" xml:space="preserve" data-v-1664b52e><path d="M225.923 354.706c-8.098 0-16.195-3.092-22.369-9.263L9.27 151.157c-12.359-12.359-12.359-32.397 0-44.751 12.354-12.354 32.388-12.354 44.748 0l171.905 171.915 171.906-171.909c12.359-12.354 32.391-12.354 44.744 0 12.365 12.354 12.365 32.392 0 44.751L248.292 345.449c-6.177 6.172-14.274 9.257-22.369 9.257z" data-original="#000000" data-v-1664b52e></path></svg></span><div class="menu-item_border" data-v-1664b52e></div><div class="submenu" data-v-1664b52e>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    to: "/",
    class: "submenu-item",
    "active-class": "menu-item_active"
  ...
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span data-v-1664b52e${_scopeId}>\u041E\u0442\u0437\u044B\u0432\u044B</span><div class="menu-item_border" data-v-1664b52e${_scopeId}></div>`);
      } else {
        return [
...
const headerMenu = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$a], ["__scopeId", "data-v-1664b52e"]]);
const _sfc_main$a = {
  name: "header-menu",
  data() {
    return {
...
//# sourceMappingURL=default-184ea25c.mjs.map
